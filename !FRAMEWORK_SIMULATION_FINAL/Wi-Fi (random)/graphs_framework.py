...
##########
plt.subplot(2, 2, 3)
plt.plot(['12/5', '24/5', '36/5', '12/10', '24/10', '36/10', '12/14', '24/14', '36/14'], [totalDownlinkSC[-1] for i in range(9)], label='RACH')
...
##########
plt.subplot(2, 2, 4)
plt.plot(['12/5', '24/5', '36/5', '12/10', '24/10', '36/10', '12/14', '24/14', '36/14'], [totalUplinkSC[-1] for i in range(9)], label='RACH')

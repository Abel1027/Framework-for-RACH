...
def main(fixedRelays, totalDevices, framework, noClassicRACH, discoverBeforeSIB1, totalNetworkSlices, maxSym, maxSC, blePower, mnPower, getFreqFromGNB, mobility, printLogs):
...
if __name__ == '__main__':
	...
	# for test
	#histogram, logs = main(fixedRelays, totalDevices, framework, noClassicRACH, discoverBeforeSIB1, totalNetworkSlices, maxSym, maxSC, blePower, mnPower, getFreqFromGNB, mobility, printLogs)
	#print(logs)
	#print(histogram)
	...
	for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
		...
		histogram, logs = main(fixedRelays, totalD, framework=False, noClassicRACH=False, discoverBeforeSIB1=False, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False)
	...
	for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
		...
		histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=False, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False)
	...
	for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
		...
		histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False)
	...
	for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
		...
		histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=False, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=True, mobility=False, printLogs=False)
	...
	for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
		...
		histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=True, mobility=False, printLogs=False)
	...
	for maxS in [5, 10, 14]:
		for maxSc in [1, 2, 3]:
			...
			histogram, logs = main(fixedRelays, 100, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxS, maxSC=maxSc, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False)
	...
	for maxS in [5, 10, 14]:
		for maxSc in [1, 2, 3]:
			...
			histogram, logs = main(fixedRelays, 1000, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxS, maxSC=maxSc, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False)
